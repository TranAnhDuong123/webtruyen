                                ...
                                <div class="col-lg-6">
                                    <?php echo $this->Form->create('Story',array('id'=>'appForm', 'inputDefaults'=>array('label'=>false, 'div'=>false),'enctype' => 'multipart/form-data')); ?>
                                        <div class="form-group">
                                            <label>Name</label>
                                            <?php
                                                echo $this->Form->input('name', array('class'=>'form-control','id'=>'inputName', 'maxlength'=>'100','value'=>$detail['Story']['name']));
                                            ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo $this->Form->select('category_id',$result,array('class'=>'form-control','empty'=>array('0'=>""),'default'=>$detail['Story']['category_id']));?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                            echo $this->Form->textarea('description', array('class'=>'form-control','id'=>'description','value'=>$detail['Story']['description']));
                                            ?>
                                        </div>
